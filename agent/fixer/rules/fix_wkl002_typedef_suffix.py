...
class FixWkl002(BaseFixer):
    """Report typedef suffix violations (unsafe to auto-fix)."""
    ...
    def propose(
        ...
        **kwargs,
        ...
        return FixProposal(
            ...
            description="[Report-Only] Report typedef suffix violations (unsafe to auto-fix). Manual intervention required.",
