...
_RE = re.compile(r'\bcovergroup\s+(\w+)')


class FixNd021(BaseFixer):
    """Insert NaturalDocs // Covergroup: <name> comment for ND-021."""
    ...
    def propose(
        ...
        **kwargs,
        ...
        return FixProposal(
            ...
            file=violation["file"],
            line=violation["line"],
            description=f"Insert // Covergroup: {name} documentation comment",
