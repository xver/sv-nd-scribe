...
_RE = re.compile(r'\bbind\s+\w+\s+\w+\s+(\w+)')


class FixNd026(BaseFixer):
    """Insert NaturalDocs // Bind: <name> comment for ND-026."""
    ...
    def propose(
        ...
        **kwargs,
        ...
        return FixProposal(
            ...
            file=violation["file"],
            line=violation["line"],
            description=f"Insert // Bind: {name} documentation comment",
