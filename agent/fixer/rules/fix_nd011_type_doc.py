...
_RE = re.compile(r'\btypedef\b.+\s(\w+)\s*;')


class FixNd011(BaseFixer):
    """Insert NaturalDocs // Type: <name> comment for ND-011."""
    ...
    def propose(
        ...
        **kwargs,
        ...
        return FixProposal(
            ...
            file=violation["file"],
            line=violation["line"],
            description=f"Insert // Type: {name} documentation comment",
