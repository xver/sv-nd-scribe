...
_RE = re.compile(r'\bclocking\s+(\w+)')


class FixNd031(BaseFixer):
    """Insert NaturalDocs // Clocking: <name> comment for ND-031."""
    ...
    def propose(
        ...
        **kwargs,
        ...
        return FixProposal(
            ...
            file=violation["file"],
            line=violation["line"],
            description=f"Insert // Clocking: {name} documentation comment",
