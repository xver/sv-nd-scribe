...
_RE = re.compile(r'`define\s+(\w+)')


class FixNd007(BaseFixer):
    """Insert NaturalDocs // define: <name> comment for ND-007."""
    ...
    def propose(
        ...
        **kwargs,
        ...
        return FixProposal(
            ...
            file=violation["file"],
            line=violation["line"],
            description=f"Insert // define: {name} documentation comment",
