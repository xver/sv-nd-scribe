...
_RE = re.compile(r'\bproperty\s+([A-Za-z0-9_]+)')


class FixNd015(BaseFixer):
    """Insert NaturalDocs comment before construct for ND-015."""
    ...
    def propose(
        ...
        **kwargs,
        ...
        return FixProposal(
            ...
            file=violation["file"],
            line=violation["line"],
            description=f"Insert // Property: {name} documentation comment",
