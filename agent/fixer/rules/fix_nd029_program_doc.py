...
_RE = re.compile(r'\bprogram\s+(\w+)')


class FixNd029(BaseFixer):
    """Insert NaturalDocs // Program: <name> comment for ND-029."""
    ...
    def propose(
        ...
        **kwargs,
        ...
        return FixProposal(
            ...
            file=violation["file"],
            line=violation["line"],
            description=f"Insert // Program: {name} documentation comment",
