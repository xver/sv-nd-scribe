...
class FixWkl003(BaseFixer):
    """Report macro format violations (unsafe to auto-fix)."""
    ...
    def propose(
        ...
        **kwargs,
        ...
        return FixProposal(
            ...
            description="[Report-Only] Report macro format violations (unsafe to auto-fix). Manual intervention required.",
