...
class FixWkl004(BaseFixer):
    """Report interface naming violations (unsafe to auto-fix)."""
    ...
    def propose(
        ...
        **kwargs,
        ...
        return FixProposal(
            ...
            description="[Report-Only] Report interface naming violations (unsafe to auto-fix). Manual intervention required.",
