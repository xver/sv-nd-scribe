...
_RE = re.compile(r'\bchecker\s+(\w+)')


class FixNd025(BaseFixer):
    """Insert NaturalDocs // checker: <name> comment for ND-025."""
    ...
    def propose(
        ...
        **kwargs,
        ...
        return FixProposal(
            ...
            file=violation["file"],
            line=violation["line"],
            description=f"Insert // Checker: {name} documentation comment",
