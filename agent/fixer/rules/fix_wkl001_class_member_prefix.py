...
class FixWkl001(BaseFixer):
    """Report class member prefix violations (unsafe to auto-fix)."""
    ...
    def propose(
        ...
        **kwargs,
        ...
        return FixProposal(
            ...
            description="[Report-Only] Report class member prefix violations (unsafe to auto-fix). Manual intervention required.",
